...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let route_name = format!("rust-sdk-client-example-{}", std::process::id());
    let runtime = Runtime::new(RuntimeOptions {
        server_id: Some(format!("rust-sdk-client-host-{}", std::process::id())),
    ...
    let response = client.call_owned("echo", b"real route-bound call")?;
    assert_eq!(response, b"real route-bound call");
