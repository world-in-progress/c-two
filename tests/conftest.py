...
@pytest.fixture(params=['thread', 'memory', 'tcp', 'http', 'ipc-v2', 'ipc-v3'])
def protocol_address(request, unique_thread_address, unique_memory_address, unique_tcp_address, unique_http_address, unique_ipc_v2_address, unique_ipc_v3_address):
