...
Verifies that:
- Duplicate names are rejected at both ServerV2 and registry level.
...
# ---------------------------------------------------------------------------
# ServerV2-level name collision
# ---------------------------------------------------------------------------

class TestServerV2NameCollision:

    def test_duplicate_name_raises(self):
        """Registering two CRMs under the same name raises ValueError."""
        server = ServerV2(bind_address=_unique_addr())
