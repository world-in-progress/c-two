> **目录规则**
>
> 本目录按日期保存设计证据。只有 [`2026-07-24 portable-payload contract composition design`](./2026-07-24-portable-payload-contract-composition-design.md) 以及 [`docs/roadmap.md`](../../roadmap.md) 明确指向的后续文档属于当前权威；更早文档是历史档案，并可能反映旧术语体系（ICRM / Component / I-prefix / `@cc.runtime.connect` 等）。
